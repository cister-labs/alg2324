...
\setLecture{2}{Algorithm Correction [WiP]}
...
\midrule
\textcolor{black!50}{6} & 4 & 5 & 4 & 5 & 5 \\
\textcolor{black!50}{7} & 4 & 5 & 3 & 5 & 5 \\
\midrule
\textcolor{black!50}{6} & 4 & 5 & 3 & 5 & 10 \\
\textcolor{black!50}{7} & 4 & 5 & 2 & 5 & 10 \\
\midrule
\textcolor{black!50}{6} & 4 & 5 & 2 & 5 & 15 \\
\textcolor{black!50}{7} & 4 & 5 & 1 & 5 & 15 \\
\midrule
\textcolor{black!50}{6} & 4 & 5 & 1 & 5 & 20 \\
\textcolor{black!50}{7} & 4 & 5 & 0 & 5 & 20 \\
\midrule
...
\col[0.32]{
  \begin{itemize}
    ...
    \item \alert{guess:} $I \stackrel{\cdot}{~=~} \texttt{a*y} + \texttt{r} = \texttt{x*y}$
    \pause
    \item Need to show:
      \\ $\texttt{x>=0} \alert{\Rightarrow} \structure{I'}$
      %~~~~(where $I' = I[\texttt{x$\backslash$a},\texttt{b$\backslash$y},\texttt{r$\backslash$0}]$)
      \\ $I \land \texttt{a>0} \alert{\Rightarrow} \structure{I'}$
      \\ $I \land \lnot(\texttt{a>0}) \alert{\Rightarrow} \texttt{r} = \texttt{x*y}$
    \pause
