...
To analyse the complexity of a recursive function, we typically define the time $T$ using \alert{recurring equations}.
...
\begin{frame}[fragile]\frametitle{Exercises}
~\\[-8mm]
\doSimpleExercise{Write recurrences for \texttt{maxSumR} (wrt array accesses) and \texttt{Hanoi} (wrt \texttt{printf})}
~\\[-12mm]
